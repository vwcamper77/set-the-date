...
export const IOS_PRO_BILLING_MESSAGE =
  'Billing management is not available in the iPhone app yet. Use the web browser version to manage Pro access.';
...
export function shouldSuppressProForNativeIOS() {
  return isIosCapacitorApp();
}
...
export function getProRuntimeCapabilities() {
  ...
  const suppressProForNativeIos = shouldSuppressProForNativeIOS();

  return {
    isNativeIosApp,
    suppressProForNativeIos,
    allowsProCheckout: !suppressProForNativeIos,
    allowsProBillingPortal: !suppressProForNativeIos,
    upgradeMessage: suppressProForNativeIos ? IOS_PRO_UPGRADE_MESSAGE : '',
    billingMessage: suppressProForNativeIos ? IOS_PRO_BILLING_MESSAGE : '',
    modalCopy: suppressProForNativeIos ? IOS_PRO_MODAL_COPY : null,
  };
}
...
export function useProRuntimeCapabilities() {
  ...
  const suppressProForNativeIos = isNativeIosApp;
