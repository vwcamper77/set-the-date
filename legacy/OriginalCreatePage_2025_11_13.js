/**
 * LEGACY: Original organiser + venue create page
 * Snapshot date: 2025-11-13
 *
 * This file is NOT used by Next.js routing.
 * It is kept only as a reference while we refactor
 * the consumer organiser flow into EventBuilder.
 */
...
const MEAL_LABELS = { breakfast: 'Breakfast', lunch: 'Lunch', dinner: 'Dinner', evening: 'Drinks' };
...
const MEAL_CHIP_OPTIONS = ['lunch', 'dinner', 'evening'];
...
export default function LegacyCreatePage() {
  ...
  const [baseMealsSelected, setBaseMealsSelected] = useState(() => sortMealsByDisplayOrder(BASE_MEALS));
  ...
  const isPartnerFlow = Boolean(partnerPrefill?.slug);
  ...
  const { calendar: calendarStepNumber, voting: votingStepNumber, context: contextStepNumber } = useMemo(() => {

    if (isPartnerFlow) {

      return { calendar: 4, voting: 5, context: null };

    }

    if (eventType === 'meal' || eventType === 'holiday') {

      return { calendar: 3, voting: 4, context: 5 };

    }

    return { calendar: 2, voting: 3, context: 4 };

  }, [eventType, isPartnerFlow]);
  ...
  const calendarStepLabel =
    ...
    eventType === 'holiday'
      ...
      ? `Step ${calendarStepNumber} - Choose the start and end of your ideal trip window`

      : `Step ${calendarStepNumber} - Pick the dates everyone should vote on`;

  const votingStepLabel = `Step ${votingStepNumber} - How long should voting stay open?`;

  const contextStepLabel = contextStepNumber ? `Step ${contextStepNumber} - Add a little context.` : null;
  ...
  const renderEventDetailsFields = ({ headingLabel = null } = {}) => (
    ...
    <>
      ...
      {headingLabel && (
        ...
        <div className="space-y-1 text-center">
          ...
          <h2 className="font-semibold text-sm">{headingLabel}</h2>
          ...
          <p className="text-xs text-gray-600">
            ...
            After you pick dates, add the event title and general location so guests know what you have in mind. You can edit these anytime.
  ...
  const renderVotingDurationField = () => {
    return (
      <>
        ...
        <div className="max-w-md w-full p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              {eventType === 'meal' && (
                ...
                <div className="bg-gray-100 border border-gray-200 rounded p-3 text-sm">
                  ...
                  <h2 className="font-medium text-sm">Step 2 · Choose which event type guests can vote on.</h2>
              ...
              {eventType === 'holiday' && (
                <div className="bg-blue-50 border border-blue-200 rounded p-3 text-sm text-blue-800 space-y-3">
                  <h2 className="font-semibold text-blue-900 text-sm">Step 2 · Sketch your ideal trip window.</h2>
                  <p>
                    First decide the trip length you want to plan, then pick a wide date window below that could fit that trip.
                    Attendees will share their ideal start, end, and length.
                  </p>
                  <div className="space-y-1">
                    <label className="block text-xs font-semibold text-blue-900" htmlFor="holiday-duration-select">
                      Proposed trip length <span className="text-blue-600">*</span>
                    </label>
                    <select
                      id="holiday-duration-select"
              ...
              {eventType === 'general' && isPartnerFlow && (
                ...
                <div className="bg-white border border-dashed border-gray-300 rounded p-3 text-sm text-gray-800 space-y-1">
                  ...
                  <h2 className="font-medium text-sm">Step 2 · Add a little context.</h2>
            ...
            {isPartnerFlow && (
              ...
              <div className="space-y-2">{renderEventDetailsFields()}</div>
            ...
            <div>
              ...
              <h2 className="block font-semibold text-center mt-2">{calendarStepLabel}</h2>
            ...
            {isPartnerFlow ? (
              ...
              <>
                ...
                <div className="space-y-4">{renderOrganiserFields()}</div>
                ...
                <div className="mt-4">{renderVotingDurationField()}</div>
              ...
              <>
                ...
                <div className="space-y-2">{renderEventDetailsFields({ headingLabel: contextStepLabel })}</div>
